...
PATH_OVERRIDE += PATH=$(BUILD_TOP)/prebuilts/tools-lineage/$(HOST_OS)-x86/perl/bin:$$PATH LD_LIBRARY_PATH=$(BUILD_TOP)/prebuilts/tools-lineage/$(HOST_OS)-x86/perl/lib:$$LD_LIBRARY_PATH
