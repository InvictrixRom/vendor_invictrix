...
cat $ANDROID_BUILD_TOP/vendor/invictrix/tools/changelog_header.fhtml > $Changelog
...
cat $ANDROID_BUILD_TOP/vendor/invictrix/tools/changelog_footer.fhtml >> $Changelog
